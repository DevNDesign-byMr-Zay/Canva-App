...
export const prototypeScenarios = Object.freeze([
  Object.freeze({
    ...
    changed: 2,
    changedElementIds: Object.freeze(['headline-1', 'body-1']),
    layout: Object.freeze({
      'logo-1': Object.freeze({ x: 40, y: 40, z: 0, locked: true }),
      'headline-1': Object.freeze({ x: 120, y: 130, z: 20, scale: 1.15 }),
      'body-1': Object.freeze({ x: 120, y: 270, z: 10, scale: 1 }),
    }),
    delta: Object.freeze({
      'headline-1': Object.freeze({ y: -18, scale: 0.15 }),
      'body-1': Object.freeze({ y: 24 }),
    }),
  ...
  Object.freeze({
    ...
    changed: 2,
    changedElementIds: Object.freeze(['card-1', 'card-2']),
    layout: Object.freeze({
      'card-1': Object.freeze({ x: 80, y: 190, z: 10 }),
      'card-2': Object.freeze({ x: 420, y: 190, z: 10 }),
    }),
    delta: Object.freeze({
      'card-1': Object.freeze({ x: -12 }),
      'card-2': Object.freeze({ x: 12 }),
    }),
    sourceSnapshotId: 'snapshot-v1',
    sourceSnapshotFingerprint: 'aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa',
  ...
  Object.freeze({
    ...
    changed: 2,
    changedElementIds: Object.freeze(['caption-1', 'caption-2']),
    layout: Object.freeze({
      'logo-1': Object.freeze({ x: 40, y: 40, z: 0, locked: true }),
      'brand-block-1': Object.freeze({ x: 40, y: 420, z: 0, locked: true }),
      'caption-1': Object.freeze({ x: 160, y: 210, z: 8 }),
      'caption-2': Object.freeze({ x: 160, y: 280, z: 8 }),
    }),
    delta: Object.freeze({
      'caption-1': Object.freeze({ y: -10 }),
      'caption-2': Object.freeze({ y: 14 }),
    }),
    sourceSnapshotId: 'snapshot-v1',
    sourceSnapshotFingerprint: 'aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa',
