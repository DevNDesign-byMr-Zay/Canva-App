...
The reviewed-snapshot binding also fails closed on duplicate or blank identities. This prevents an ambiguous snapshot or changed-element set from being normalized through `Map` key replacement.
