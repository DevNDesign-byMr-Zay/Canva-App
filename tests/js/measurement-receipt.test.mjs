...
const measurement = {
  ...
  result: { backend: 'canva-runtime-qis-reference-v1', algorithm: 'exact-independent-binary-baseline', objective: -3, bits: [1, 1] },
  durationMs: 4,
};
...
test('bridges a validated measurement into the maintained receipt shape', () => {
  assert.deepEqual(createReceiptFromMeasurement(measurement, { startedAt: '2026-09-13T05:30:00.000Z' }), {
    ...
    problem: { kind: 'binary-linear', version: 1, variableCount: 2 },
    solver: { backend: 'canva-runtime-qis-reference-v1', algorithm: 'exact-independent-binary-baseline', seed: undefined },
    objective: -3,
    bits: [1, 1],
