...
function designSnapshot(): CanvaDesignSnapshot {
  return {
    ...
    elements: [
      { id: "headline", type: "text", top: 80, left: 64, width: 420, height: 80, rotation: 0, locked: false },
      { id: "card-a", type: "shape", top: 220, left: 100, width: 240, height: 180, rotation: 0, locked: false },
      { id: "card-b", type: "shape", top: 220, left: 400, width: 240, height: 180, rotation: 0, locked: false },
      { id: "brand-logo", type: "image", top: 40, left: 920, width: 180, height: 90, rotation: 0, locked: true },
      { id: "content-card", type: "shape", top: 288, left: 236, width: 360, height: 240, rotation: 0, locked: false },
    ],
