...
export function createHolographicScene({ id, title = '', nodes = [], exportProfile = 'simulator' } = {}) {
...
export function planFromCanvaAssets(assets = [], { sceneId = 'canva-hologram', title = 'Canva Holographic Scene' } = {}) {
