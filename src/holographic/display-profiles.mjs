...
export function getDisplayProfile(name = 'simulator') {
  ...
  return Object.freeze({ schema: DISPLAY_PROFILE_SCHEMA, id: name.trim(), ...profile });
}

export function validateDisplayProfile({ target, displayProfile = 'simulator' } = {}) {
